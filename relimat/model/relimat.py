...
from relimat.model.big_modules import PixelEncoder, UncertPred, KeyProjection, MaskEncoder, PixelFeatureFuser, MaskDecoder
from relimat.model.aux_modules import AuxComputer
from relimat.model.utils.memory_utils import get_affinity, readout
from relimat.model.transformer.object_transformer import QueryTransformer
from relimat.model.transformer.object_summarizer import ObjectSummarizer
from relimat.utils.tensor_utils import aggregate
from relimat.utils.device import get_default_device, safe_autocast

device = get_default_device()

log = logging.getLogger()
class relimat(nn.Module,
                PyTorchModelHubMixin,
                library_name="relimat",
                repo_url="https://github.com/pq-yang/relimat",
                coders={
                    DictConfig: (
