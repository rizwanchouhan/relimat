...
from relimat.inference.kv_memory_store import KeyValueMemoryStore
from relimat.model.relimat import relimat
from relimat.model.utils.memory_utils import get_similarity, do_softmax
...
class MemoryManager:
    ...
    def read_first_frame(self, last_msk_value, pix_feat: torch.Tensor, 
             last_mask: torch.Tensor, network: relimat, uncert_output=None) -> Dict[int, torch.Tensor]:
        """
    ...
    def read(self, pix_feat: torch.Tensor, query_key: torch.Tensor, selection: torch.Tensor,
             last_mask: torch.Tensor, network: relimat, uncert_output=None, last_msk_value=None, ti=None,
