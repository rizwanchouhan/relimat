...
from relimat.inference.memory_manager import MemoryManager
from relimat.inference.object_manager import ObjectManager
from relimat.inference.image_feature_store import ImageFeatureStore
from relimat.model.relimat import relimat
from relimat.utils.tensor_utils import pad_divide_by, unpad, aggregate
...
class InferenceCore:
    ...
    def __init__(self,
        ...
        if isinstance(network, str):
            network = relimat.from_pretrained(network)
        network.to(device)
        network.eval()
