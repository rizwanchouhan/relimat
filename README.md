...
<table>
  <tr>
    <td style="text-align: center;">
      <p>Input Video</p>
      <img width="230" src="https://github.com/rizwanchouhan/relimat/blob/main/resources/video1.gif" alt="input video">
    </td>
    <td style="text-align: center;">
      <p>Foreground</p>
      <img width="230" src="https://github.com/rizwanchouhan/relimat/blob/main/resources/video2.gif" alt="Foreground">
    </td>
    <td style="text-align: center;">
      <p>Alpha Output</p>
      <img width="230" src="https://github.com/rizwanchouhan/relimat/blob/main/resources/video3.gif" alt="Alpha Output">
    </td>
  </tr>
</table>
